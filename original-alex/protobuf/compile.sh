...
pydir=${SCRIPTPATH}/../protobuf-models/etc/vision/protobuf/data/models
...
generate_models() {
    ...
    /opt/oasys/third-party/protobuf/bin/protoc -I. --cpp_out=.gen ${name}.proto
    /opt/oasys/third-party/protobuf/bin/protoc -I. --python_out=${pydir} ${name}.proto
